...
#########################################################################################
# A script to set up our tests with working cookies to simulate calls from the SPA client
#########################################################################################
...
#
# Get the data that we will use in the main test workflows
#
JSON=$(tail -n 1 $RESPONSE_FILE)
